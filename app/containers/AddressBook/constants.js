...
export const FETCH_CONTACTS = 'app/AddressBook/FETCH_CONTACTS';
...
export const UPDATE_CONTACT = 'app/AddressBook/UPDATE_CONTACT';
export const ADDING = 'app/AddressBook/ADDING';
export const SEARCHING = 'app/AddressBook/SEARCHING';
